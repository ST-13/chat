...
public class DemoData {
    ...
    public static void init(Logger log) {
        ...
        Application.userRepository.save(hulk);
        Application.userRepository.save(deadpool);
        Application.userRepository.save(flash);
        Application.userRepository.save(batman);
        Application.userRepository.save(catwoman);

        // save some active chats
        Application.chatRepository.save(allHeroChat);
        Application.chatRepository.save(badGuysChat);
